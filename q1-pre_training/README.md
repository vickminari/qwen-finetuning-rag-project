...
Isso salvará as métricas quantitativas e algumas gerações qualitativas no arquivo `baseline_evaluation.json`.
...
Isso gerará o relatório Markdown `benchmark_comparison_report.md` estruturando as perguntas, respostas de referência, respostas do modelo base e respostas do modelo CPT de forma comparativa.
